...
\midrule
Zhao et al.\ (2026) & $O(NQ^2/\eps^2)$ & $1\times$ \\
...
\subsection{Expected-Unitary Oracle Sketching (Zhao et al.\ 2026)}
...
% Implementation: src/qos/core/oracle_sketch.py::q_oracle_sketch_boolean
% Tests: tests/test_core.py, tests/test_tvd_core.py
...
% Implementation: src/qos/core/oracle_sketch.py::q_oracle_sketch_boolean
% Tests: tests/test_core.py (uniform-oracle error scaling)
...
% Implementation: src/qos/core/oracle_sketch.py::q_oracle_sketch_boolean_adaptive
% Tests: tests/test_adaptive_boolean.py, tests/test_core.py
\begin{algorithm}[H]
...
% Implementation: src/qos/core/oracle_sketch.py::q_oracle_sketch_boolean_adaptive
%                 src/qos/theory/adaptive_lower_bound.py::compute_bounds
% Tests: tests/test_adaptive_boolean.py, tests/test_lower_bound.py
...
% Implementation: src/qos/theory/adaptive_lower_bound.py::compute_bounds
% Tests: tests/test_lower_bound.py
...
% Implementation: src/qos/theory/hierarchical_sketch.py::HierarchicalOracleSketch.build
%                 src/qos/theory/hierarchical_sketch.py::compute_hierarchical_sample_complexity
...
% Implementation: src/qos/theory/hierarchical_sketch.py::compute_hierarchical_sample_complexity
% Tests: tests/test_hierarchical_sketch.py
...
% Implementation: src/qos/theory/variational_warmstart.py::VariationalWarmstart
% Tests: tests/test_variational_warmstart.py, tests/test_warmstart_e2e.py
...
% Implementation: src/qos/theory/hierarchical_sketch.py::compute_hierarchical_sample_complexity
%                 (combined with adaptive + variational scaling)
% Tests: tests/test_hierarchical_sketch.py, tests/test_theory_fixes.py
...
% Implementation: src/qos/theory/interferometric_shadow.py::InterferometricClassicalShadow
% Tests: tests/test_interferometric_shadow.py, tests/test_kernel_shadow.py
...
\bibitem{zhao2026exponential} H.\ Zhao, A.\ Zlokapa, H.\ Neven, R.\ Babbush, J.\ Preskill, J.\ R.\ McClean, and H.-Y.\ Huang. \emph{Exponential quantum advantage in processing massive classical data}. arXiv:2604.07639, 2026.
